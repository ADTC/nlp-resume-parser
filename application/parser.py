...
"""Summarize below text into valid minified JSON with exactly this structure: {phone_number, headline, summary, website_or_github, linkedin, twitter, facebook, instagram, work_experience: [{job_title, company, industry, from_month_year, to_month_year, job_description}], education: [{degree, institution, major, from_month_year, to_month_year, description}]}
"""
